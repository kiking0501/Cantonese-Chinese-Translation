...
class RNNModel:
    ...
    def getEncoderModel(self, config, bucket_num=-1, mode='training', reuse=False):
        ...
        #placeholders
        if mode == 'training':
            token_lookup_sequences_placeholder = \
    ...
    def getDecoderOutput(self,
                         output, lstm_cell_size, token_vocab_size,
                         w_out, b_out, w_context_out, b_context_out,
                         context=None):
    ...
    def initEmbeddings(self, emb_scope, token_vocab_size, embeddings_dim,
                       reuse=False, pretrained_embeddings=None):
